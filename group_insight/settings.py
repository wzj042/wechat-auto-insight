...
# DeepSeek v4 系列最大输出为 384K，1M 上下文；4K/8K 在旧版 V3 时代合理，
# 对 v4 过于保守，容易导致长报表或 reduce 结果被截断。
DEFAULT_STRUCTURED_STAGE_MAX_TOKENS = 32768
# 思考模式开启后，为结构化阶段适当放宽输出预算。
DEFAULT_STRUCTURED_STAGE_MAX_TOKENS_THINKING = 65536
